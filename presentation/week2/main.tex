...
\begin{equation*}
   \int f(x) p(x)  \ \text{d}x
\end{equation*}
In our framework, we will take advantage of quadrature techniques and use the estimated distribution over the integral's value to guide the optimization procedure.
\end{frame}
